    ...
    <Toaster position="top-right" richColors />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-9">
          <div>
            <p className="text-3xl font-bold text-orange-600 tracking-[0.35em] uppercase mb-2.5">
              CW
            </p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 pt-6 border-t border-slate-100">
            ...
            {event.status === "Upcoming" ? (
              <motion.button
                ...
                className="w-full sm:w-auto ml-auto px-8 py-4 rounded-2xl bg-orange-600 text-white text-sm font-bold uppercase tracking-widest shadow-xl shadow-slate-200"
              >
                Reserve Seat
              </motion.button>
            ) : (
...
function RegistrationForm({ event, formData, onSubmit, onChange, onClose }) {
  return (
    ...
    >
      ...
      >
        <div className="absolute top-0 left-0 w-full h-24 bg-orange-600" />
        <button
          onClick={onClose}
        ...
        <div className="relative z-10 p-8 pb-12">
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              type="submit"
              className="w-full py-4 px-6 bg-orange-600 text-white font-bold text-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all tracking-wider"
            >
              Secure My Seat
            </motion.button>
          </form>
